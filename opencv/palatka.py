...
lower_mask = np.array([132, 146, 127], dtype="uint8")
upper_mask = np.array([141, 155, 133], dtype="uint8")
# lower_mask = matplotlib.colors.rgb_to_hsv(lower_mask)
# upper_mask = matplotlib.colors.rgb_to_hsv(upper_mask)

rawFrame = cv2.imread("test.bmp")
