...
class UAViantSystemClient:public IUartPacketsClient
{
 ...
 public:
   UAViant_IO_Formatter* UAViant_IO;
	...
	UAViantSystemClient(HardwareSerial* a_Serial, ITask1Interface* a_task1 =  nullptr,ITask8Interface *a_task8 = nullptr){
	...
	UAViantSystemClient(HardwareSerial* a_Serial, ITask8Interface* a_task8 = nullptr) {
